...
namespace PwnAdventure3Hax
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //{
                //Run the hack...
                RunHack(new PwnieHax04_PointerChain());
            //}
            //catch (Exception ex)
            //{
        ...
        {
            Console.WriteLine("Creating hack context...");
            var hackContext = LocalHackContext.CreateContext("PwnAdventure3-Win32-Shipping", true);
            Console.WriteLine("Process: PID({0})", hackContext.Process.PID);
